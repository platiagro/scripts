#!/bin/bash
sudo docker pull platiagro/projects:0.3.1
sudo docker pull platiagro/web-ui:0.3.1
sudo docker pull platiagro/tasks:0.3.1
sudo docker pull platiagro/datasets:0.3.1
...
cd manifests && while ! kustomize build platiagro | kubectl apply -f -; do echo "Retrying to apply resources"; sleep 10; done
